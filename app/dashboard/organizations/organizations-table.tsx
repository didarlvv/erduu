    ...
    <div className="space-y-4">
      <div className="rounded-md border">
        <Table>
          <TableHeader>
            <TableRow>
              <TableHead className="w-[250px]">{translate("organizations.table.structure")}</TableHead>
              <TableHead>{translate("organizations.table.name")}</TableHead>
              <TableHead>{translate("organizations.table.slug")}</TableHead>
              <TableHead>{translate("organizations.table.id")}</TableHead>
              <TableHead className="text-right">{translate("organizations.table.actions")}</TableHead>
            </TableRow>
          </TableHeader>
          <TableBody>
            {loading ? (
